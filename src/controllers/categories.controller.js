...
const { Category, User } = require('../database/models/index')
const sequelize = require('sequelize');

//API

const findAll = async(req, res) => {
    let categories = await Category.findAll({ order: sequelize.literal('id ASC') });
...
const store = async(req, res) => {
    ...
    let categories = await Category.create(params)
    if (categories) {
